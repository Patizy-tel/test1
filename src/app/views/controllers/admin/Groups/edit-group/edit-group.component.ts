...
import { Groups } from 'src/app/tools/models';
import { GroupService, AlertService } from 'src/app/tools/services';
...
export class EditGroupComponent implements OnInit {
  ...
  constructor(private group: GroupService, private alerts: AlertService,
    ...
    this.group.getOneGroup(this.data.id).subscribe((resp:Groups)=>{
       console.log(resp);
       this.editGroup =resp
